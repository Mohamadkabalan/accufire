...
class SubscriptionCron implements CronInterface {
	public static function cronJob() {
		$connector = new SDK();
		$logger = new Logger();
		// TODO: Common options among payment methods (like base url and api key) should originate from a common settings page
		// `paymentgateway` is the Credit Card method id
		$options = GatewayConfig::getOptions();
		$connector->apiKey = $options['api_key'];
		$connector->url = $options['api_url'];
		...
		foreach ($subscriptions as $subscription) {
			...
			// If the subscription doesn't have an ID it doesn't exist in the gateway
